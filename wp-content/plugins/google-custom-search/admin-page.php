...
<div class="wrap">
    ...
    <form name="rssForm" method="post" action="admin.php?page=<?php echo $gcs_plugin_name ?>">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <th scope="row">Search engine unique ID <a href="http://www.google.com/cse/" target="_blank">(create one
                        with google)</a>:
                </th>
                <td><input type="text" name="gsc_search_engine_id"
                           value="<?php echo get_option($gsc_search_engine_id); ?>" size=40/> (e.g:
                    095382442174838362754:hisuukncdfg )
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">Display results in same window:</th>
                <td><input name="gsc_open_results_in_same_window" type="checkbox"
                           value="yes"  <?php if (get_option($gsc_open_results_in_same_window) == "yes") {
                        echo "checked";
                    } ?> />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (if unchecked results open in new window)
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">Hide search button:</th>
                <td><input name="gsc_hide_search_button" type="checkbox"
                           value="yes"  <?php if (get_option($gsc_hide_search_button) == "yes") {
                        echo "checked";
                    } ?> /></td>
            </tr>
        </table>
    ...
    Go to <a href="http://www.google.com/cse/manage/create" target="_blank">http://www.google.com/cse/manage/create</a>
    and follow the instructions.</a>
    <h5>2) Retrieve Search Engine Unique ID from Google</h5>
    Go to <a href="http://www.google.com/cse/manage/all" target="_blank">http://www.google.com/cse/manage/all</a> and
    click on the control panel for your search engine.<br/>
    ...
    <p>
        <b>For more information go to <a href="http://littlehandytips.com/plugins/google-custom-search/"
                                         target="_blank">Little Handy Tips</a>.</b>
        <?php
