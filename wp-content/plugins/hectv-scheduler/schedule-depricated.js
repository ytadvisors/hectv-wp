...
jQuery(document).ready(function (){
	...
	jQuery("form#inspector-operations").submit(function(event){
	...
	jQuery("form#inspector-form").submit(function(event){
				...
				success: function(data) {
					...
					if( data.action == "delete" ){
						...
						for( var x = 0; x < data.blocks; x++ ){
							...
							jQuery( "td#" + insertID ).html( data.series_title + ":&nbsp;" + data.episode_title );
							jQuery( "td#" + insertID ).addClass("active");
