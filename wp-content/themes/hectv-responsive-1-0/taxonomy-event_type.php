                ...
                <div class="inner">
                    ...
                    <div class="calendar clearfix">
                        ...
                        <div class="month">
							...
							<?php $calendarName = ( $wp_query->query_vars['event_type'] ) ? ucfirst( $wp_query->query_vars['event_type'] ) . " Events" : ""; ?>

                            <span class="month"><?php echo $calendarName; ?> <?php echo $queryMonthName; ?> <?php echo $queryYear; ?></span>
	                    ...
	                    <?php $eventPostsQueryParameters = array( 'posts_per_page' => -1,
																  ...
																  'meta_query'     => array(
																   ...
																   'tax_query' => array(
																		...
																		'taxonomy' => 'event_type',
																		'field' => 'name',
																		'terms' => array( $wp_query->query_vars['event_type'] )
																	)
																)
																); ?>
