jQuery(document).ready(function(){
	...
	function displayActive(){
		...
		jQuery("ul#events-listing").find("li.event-post").removeClass("hide-border").hide();
		jQuery("ul#events-listing").find("li.event-post[data-date='" + query + "']").show();
		jQuery("ul#events-listing").find("li.event-post[data-date='" + query + "']").addClass("hide-border");

		if( jQuery("ul#events-listing").find("li.event-post:visible").length == 0 ) {

			jQuery("ul#events-listing").find("li#no-results").show();

		}else{

			jQuery("ul#events-listing").find("li#no-results").hide();
