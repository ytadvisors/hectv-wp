<?php
/*
Template Name: Series | Hec-TV Live
*/
?>
...
<?php $seriesData = get_post_custom( $post->ID ); ?>

<main id="series" class="clearfix endless">
...
<!--         <section id="series-media" class="endless-media page-left" data-elm="div.content-row" data-tgt="section#series-media" rel="1"> -->
		<section id="series-media" class="endless-media page-left" data-elm="div.content-row" data-tgt="section#series-media" rel="1">
            ...
            <div id="series-info" class="module">
	            ...
	            <ul class="tabs clearfix">
		            ...
		            <?php $relatedLinks = unserialize( $seriesData['related_links'][0] ); ?>
					...
					<li><a href="#" class="tab-nav <?php echo ( empty( $seriesData['education_copy'][0] ) ) ? 'disabled':''; ?>" rel="section-educational-material">Educational Material</a></li>
				...
				<section>
					...
					<div id="section-educational-material" class="tab-section">
						...
						<p><?php echo $seriesData['education_copy'][0]; ?></p>
        ...
        <section class="page-right"> <!--- Start Page Right -->
			...
			<?php if( have_rows('upcoming_episodes') ): ?>

				<?php $x = 0; ?>
				<?php while ( have_rows('upcoming_episodes') ) : the_row(); ?>

					<?php $data = get_field('upcoming_episodes'); ?>

					<?php if( get_sub_field('episode_link') ){ ?>

					<?php hectv_create_rsvp_slat( get_sub_field('episode_link'), false, $data[$x] ); ?>
